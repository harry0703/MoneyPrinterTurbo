...
if (-not $rule) {
  $cmd = 'New-NetFirewallRule -DisplayName ''MoneyPrinterTurbo Remoto'' -Direction Inbound -Action Allow -Protocol TCP -LocalPort 8501-8599 -RemoteAddress 100.64.0.0/10 -Profile Any | Out-Null'
...
<body>
  ...
  <div class="cards">
    <div class="card">
      ...
      <div class="qr"><div id="qrApp"></div></div>
      <ol>
    ...
    <div class="card">
      ...
      <div class="qr"><div id="qrAcesso"></div></div>
      <ol>
...
<script>
new QRCode(document.getElementById("qrApp"), {text: "https://apps.apple.com/app/tailscale/id1470499037", width: 200, height: 200});
new QRCode(document.getElementById("qrAcesso"), {text: "$($script:url)", width: 200, height: 200});
</script>
</body>
</html>
"@
