...
def generate_subtitle(task_id, params, video_script, sub_maker, audio_file):
    ...
    # Edge provider requires sub_maker (from TTS)
    if subtitle_provider == "edge" and sub_maker is None:
        logger.warning("edge subtitle provider requires sub_maker, but it is None (possibly using custom audio).")
        return ""
    ...
    if subtitle_provider in ["whisper", "openvino"] or subtitle_fallback:
