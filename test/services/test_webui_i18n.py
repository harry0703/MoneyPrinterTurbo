...
ENGLISH_FALLBACK_KEYS = frozenset(
    {
        ...
        "TensorScale MiniMax H3 Fast",
        "TensorScale MiniMax H3 Fast Help",
        "TensorScale API Key",
        "TensorScale Base URL",
        "TensorScale Resolution",
        "TensorScale Resolution Help",
        "Please Enter the TensorScale API Key",
        "TensorScale Billing Notice",
        "TensorScale Billing Notice Without Script",
        "Confirm TensorScale Charge",
        "Confirm TensorScale Charge Help",
        "Confirm TensorScale Charge Required",
