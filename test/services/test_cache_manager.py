...
class TestVideoCacheManager(unittest.TestCase):
    """Verify that cache management only touches controlled files and performs lightweight stats and cleanup by metadata."""
    ...
    def test_stats_only_include_managed_top_level_regular_files(self):
        """
        Unknown files, nested files, and symlinks may belong to the user and must not enter
        capacity accounting or cleanup candidates.
        """
        now = 2_000_000_000.0
        ...
        try:
            ...
            # Without Windows developer mode, creating symlinks may lack permission; this does not affect the other assertions.
            pass
