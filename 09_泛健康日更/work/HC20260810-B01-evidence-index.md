...
- 每卡最低独立来源数：2
- 逐字引文总数：0
- 公开块规则：只允许事实、明确标记的保守推断和生活观察建议；来源标题、研究内部术语和禁止外推仅保留在 private 区域。

## 十题一一映射与证据强度

| 槽位 | 内容 ID | 批次主题（逐字） | 主要来源组合 | 强度 | 核心边界 |
|---:|---|---|---|---|---|
| 1 | HC20260810-001 | 午饭后总想打盹，先观察3件事 | CDC/NIOSH + 原始交叉实验 | 中等偏低 | 困意为多因素，不作单因判断 |
| 2 | HC20260810-002 | 吃饭太快，下午状态有什么不同 | 国家卫健委 + 原始随机交叉实验 | 中等 | 慢吃不保证下午更清醒 |
| 3 | HC20260810-003 | 午餐吃得太撑，下午怎么安排更舒服 | 国家卫健委 + 原始小样本研究 | 中等偏低 | 不过量也不极端补偿；无统一份量 |
| 4 | HC20260810-004 | 饭后一直坐和轻松走动，感受有什么不同 | WHO 指南 + 原始交叉先导实验 | 中等 | 走动不保证必然更好；3 分钟不是阈值 |
...
| R08 | 官方职业指南 | CDC/NIOSH | 2020-03-31 | Rest Breaks | https://www.cdc.gov/niosh/work-hour-training-for-nurses/longhours/mod5/10.html | 休息作用时长未知、受多因素影响 |
| R09 | 系统综述/荟萃分析 | PLOS ONE | 2022-08-31 | “Give me a break!” | https://doi.org/10.1371/journal.pone.0272460 | 微休息小效应、总体表现不确定 |
| R10 | 官方职业指南 | CDC/NIOSH | 2020-03-31 | Nap Duration | https://www.cdc.gov/niosh/work-hour-training-for-nurses/longhours/mod7/05.html | 睡眠惯性、时长与睡眠背景 |
...
| R19 | 原始纵向研究 | Wiley | 2009-07-16 / 2010-10 | How are habits formed | https://doi.org/10.1002/ejsp.674 | 习惯形成时间差异，否定 7 天阈值 |

## 批次级证据边界

- 事实：官方指南支持减少久坐、规律而不过量的进餐、记录睡眠/吃喝/时点以及困倦驾驶先停车；原始研究显示午后体验和行为效果受人群、任务、剂量与时点影响。
- 保守推断：适合把每集设计成同一个人的重复观察，而不是跨人群的统一规则。
- 生活观察：手机点选、3 分钟计时和 7 天窗口都是低门槛编辑设计，不是医学结论、量表或科学阈值。
- public-ready 禁止：疾病名称、诊断推断、指标解读、器械展示、专业身份、疗效承诺和统一分钟数/数量承诺。
- private forbidden extrapolations 可以列出需拦截的错误说法，但不得进入旁白、字幕、封面、图文或四平台发布字段。
