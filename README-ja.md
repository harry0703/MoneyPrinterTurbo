...
> [!NOTE]
> **映像の作成方法：** デフォルトでは、MoneyPrinterTurbo はローカル素材、または Pexels、Pixabay、Coverr から取得した既存の映像を使い、生成した台本、ナレーション、字幕、音楽と組み合わせて自動編集します。素材ソースに WaveSpeed AI を選択した場合は、テキスト動画生成モデルで新しい映像を生成します。
