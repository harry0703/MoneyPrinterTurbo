...
- [x] Supports multiple stock video providers: **Pexels**, **Pixabay**, and **Coverr** (free CC0 HD/4K, mostly 16:9 landscape; register at [coverr.co/developers](https://coverr.co/developers?ctx=header_navigation), Demo tier 50 requests/hour)
