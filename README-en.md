...
- [x] Generate 4–15 second `360p`/`480p`/`768p` clips through the asynchronous TensorScale MiniMax H3 Fast API and download completed results from short-lived signed URLs
